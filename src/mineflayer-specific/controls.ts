 ...
 * @returns
 */
export function getControllerStrafeAim(nextPoint: Vec3): Controller {
 ...
 * @returns
 */
export function getBotStrafeAim(bot: Bot, nextPoint: Vec3) {
  return () => {
 ...
 * @returns
 */
export function getControllerSmartMovement(goal: Vec3, sprint: boolean): Controller {
  return (state: EntityState, ticks: number) => {
 ...
 * @returns
 */
export function getBotSmartMovement(bot: Bot, goal: Vec3, sprint: boolean) {
  return () => {
    const offset = bot.entity.position.plus(bot.entity.velocity);
    const dx = goal.x - offset.x;
    const dz = goal.z - offset.z;
